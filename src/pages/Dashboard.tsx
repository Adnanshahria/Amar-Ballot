                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 sm:gap-4">
                                ...
                                <div className="flex-1 space-y-2 sm:space-y-3 text-center sm:text-left">
                                    <div className="flex justify-between items-start">
                                        <div className="w-full sm:w-auto">
                                            <h3 className="text-green-100 text-[9px] sm:text-[10px] uppercase tracking-widest mb-0.5">National Identity Card</h3>
                    ...
                    <div className="space-y-3 sm:space-y-4">
                        ...
                        <div className="bg-white rounded-2xl p-3 sm:p-4 shadow-sm border border-green-100">
                            <h3 className="text-gray-500 text-[10px] sm:text-xs font-medium uppercase tracking-wider mb-2 sm:mb-3 text-center sm:text-left">Next Election In</h3>
                            <div className="flex justify-between text-center max-w-[240px] mx-auto sm:max-w-none">
                                <div>
                                    ...
                                    <div className="text-[9px] sm:text-[10px] text-gray-500 uppercase mt-0.5">Days</div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="text-[9px] sm:text-[10px] text-gray-500 uppercase mt-0.5">Hours</div>
                                </div>
                                <div className="text-lg sm:text-xl text-gray-300 font-light pt-0.5">:</div>
                                <div>
                                    <div className="text-xl sm:text-2xl font-bold text-green-700">{minutes}</div>
                                    <div className="text-[9px] sm:text-[10px] text-gray-500 uppercase mt-0.5">Mins</div>
                                </div>
                            </div>
                            <div className="mt-2 sm:mt-3 pt-2 sm:pt-3 border-t border-gray-100 text-center">
                                ...
                                <p className="text-[9px] sm:text-[10px] text-gray-500">Scheduled for February 12, 2026</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-green-50 rounded-2xl p-3 sm:p-4 border border-green-100 flex items-center gap-3 sm:gap-4">
                            ...
                            <div>
                                <p className="text-[10px] sm:text-xs text-gray-600">Voting Eligibility</p>
